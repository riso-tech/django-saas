      ...
      return (
                  ...
                  container: function (e, o) {
                    var s =
                        'string' == typeof t.opts.rowSelector
                          ? t.opts.rowSelector
                          : t.opts.rowSelector(e, o),
                      a = i(o, s);
                    return n.Message.getClosestContainer(
                      o,
                      a,
                      t.opts.rowPattern,
                    );
        ...
        (t.prototype.removeClasses = function (e, t) {
          ...
          t.forEach(function (e) {
            ...
            s(
              e,
              (((t = {})[o.opts.eleValidClass] = !1),
              (t[o.opts.eleInvalidClass] = !1),
              t),
            );
          });
        ...
        (t.prototype.onElementValidated = function (e) {
          ...
          i.forEach(function (t) {
            ...
            s(
              t,
              (((n = {})[o.opts.eleValidClass] = e.valid),
              (n[o.opts.eleInvalidClass] = !e.valid),
              n),
            );
          });
