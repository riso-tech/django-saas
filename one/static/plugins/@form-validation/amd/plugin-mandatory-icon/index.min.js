      ...
      return (
        ...
        (t.prototype.onIconPlaced = function (e) {
          ...
          if (o && o.notEmpty && !1 !== o.notEmpty.enabled && a.length) {
            ...
            for (
              ...
              '' === this.core.getElementValue(e.field, r) &&
                i(e.iconElement, (((t = {})[this.opts.icon] = !0), t));
            }
          }
          ...
          Object.keys(h).forEach(function (e) {
            for (var t = [], i = 0, o = p; i < o.length; i++) {
              var a = o[i];
              -1 === h[e].indexOf(a) && t.push(a);
            }
            n.removedIcons[e] = t.join(' ');
          });
        }),
        ...
        (t.prototype.updateIconClasses = function (e, t) {
          var n,
            o = this.icons.get(e);
          o &&
            this.iconClasses &&
            ...
            i(
              o,
              (((n = {})[this.removedIcons[t]] = !1),
              (n[this.opts.icon] = !1),
              n),
            );
        }),
        (t.prototype.onIconSet = function (e) {
          var t,
            n = this.icons.get(e.element);
          n &&
            (('NotValidated' === e.status &&
              '' === this.core.getElementValue(e.field, e.element)) ||
              'Ignored' === e.status) &&
            i(n, (((t = {})[this.opts.icon] = !0), t));
        }),
        t
      );
    })(t.Plugin);
