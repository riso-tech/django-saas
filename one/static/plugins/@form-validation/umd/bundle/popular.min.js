        ...
        return {
          validate: function (r) {
            ...
            var I = 'function' == typeof o.min ? o.min() : o.min,
              ...
              j = I instanceof Date ? i(H, o.format) : I,
              k = _ instanceof Date ? i(S, o.format) : _;
            switch (!0) {
              case !!j && !k:
                return {
                  message: t(r.l10n ? r.l10n.date.min : a, j),
                  meta: { date: w },
                  valid: w.getTime() >= H.getTime(),
                };
              case !!k && !j:
                return {
                  message: t(r.l10n ? r.l10n.date.max : a, k),
                  meta: { date: w },
                  valid: w.getTime() <= S.getTime(),
                };
              case !!k && !!j:
                return {
                  message: t(r.l10n ? r.l10n.date.range : a, [j, k]),
                  meta: { date: w },
                  valid:
