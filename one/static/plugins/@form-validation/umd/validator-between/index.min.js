  ...
  return function () {
    ...
    return {
      validate: function (o) {
        var t = o.value;
        if ('' === t) return { valid: !0 };
        var n = Object.assign({}, { inclusive: !0, message: '' }, o.options),
          i = e(n.min),
          r = e(n.max);
        return n.inclusive
          ? {
              message: a(
                o.l10n ? n.message || o.l10n.between.default : n.message,
                [''.concat(i), ''.concat(r)],
              ),
              valid: parseFloat(t) >= i && parseFloat(t) <= r,
            }
          : {
              message: a(
                o.l10n ? n.message || o.l10n.between.notInclusive : n.message,
                [''.concat(i), ''.concat(r)],
              ),
              valid: parseFloat(t) > i && parseFloat(t) < r,
            };
