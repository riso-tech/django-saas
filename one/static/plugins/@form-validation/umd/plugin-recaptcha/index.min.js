  ...
  return (function (e) {
    function o(t) {
      ...
      return (
        ...
        (i.opts = Object.assign({}, o.DEFAULT_OPTIONS, t)),
    ...
    return (
          ...
          var a = {
              ...
              callback: function () {
                '' === e.opts.backendVerificationUrl &&
                  ...
                  e.core.updateFieldStatus(o.CAPTCHA_FIELD, 'Valid'));
              },
              'error-callback': function () {
                (e.captchaStatus = 'Invalid'),
                  e.core.updateFieldStatus(o.CAPTCHA_FIELD, 'Invalid');
              },
              'expired-callback': function () {
                (e.captchaStatus = 'NotValidated'),
                  e.core.updateFieldStatus(o.CAPTCHA_FIELD, 'NotValidated');
              },
              sitekey: e.opts.siteKey,
              size: e.opts.size,
            },
            n = window.grecaptcha.render(e.opts.element, a);
          e.widgetIds.set(e.opts.element, n),
            e.core.addField(o.CAPTCHA_FIELD, {
              validators: {
                promise: {
                      ...
                      : '' === e.opts.backendVerificationUrl
                        ...
                        : 'Valid' === e.captchaStatus
                          ...
                          : i(e.opts.backendVerificationUrl, {
                              method: 'POST',
                              params: ((a = {}), (a[o.CAPTCHA_FIELD] = n), a),
                            })
                              .then(function (t) {
      ...
      (o.prototype.uninstall = function () {
        ...
        [].slice
          ...
          this.core.removeField(o.CAPTCHA_FIELD);
      }),
      (o.prototype.getScript = function () {
        ...
        return 'https://www.google.com/recaptcha/api.js?onload='
          .concat(o.LOADED_CALLBACK, '&render=explicit')
          .concat(e);
      }),
      (o.prototype.preValidate = function () {
        var e = this;
        if (
      ...
      (o.prototype.onResetField = function (e) {
        if (
          e.field === o.CAPTCHA_FIELD &&
          this.widgetIds.has(this.opts.element)
        ) {
          var t = this.widgetIds.get(this.opts.element);
      ...
      (o.CAPTCHA_FIELD = 'g-recaptcha-response'),
      (o.DEFAULT_OPTIONS = {
      ...
      (o.LOADED_CALLBACK = '___reCaptchaLoaded___'),
      o
    );
  })(e.Plugin);
});
