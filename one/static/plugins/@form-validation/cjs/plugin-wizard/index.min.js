  ...
  i = (function (t) {
    ...
    return (
      ...
      (i.prototype.install = function () {
        ...
        var p = this.core.getFormElement();
        (this.steps = [].slice.call(
          p.querySelectorAll(this.opts.stepSelector),
        )),
          (this.numSteps = this.steps.length),
          this.steps.forEach(function (t) {
            var e;
            s(t, (((e = {})[n.opts.stepClass] = !0), e));
          }),
          ...
          (this.prevButton =
            'string' == typeof this.opts.prevButton
              ? '#' === this.opts.prevButton.substring(0, 1)
                ...
                : p.querySelector(this.opts.prevButton)
          ...
          (this.nextButton =
            'string' == typeof this.opts.nextButton
              ? '#' === this.opts.nextButton.substring(0, 1)
                ...
                : p.querySelector(this.opts.nextButton)
      ...
      (i.prototype.goToNextStep = function () {
        var t = this;
      ...
      (i.prototype.goToStep = function (t) {
        var e, n;
        s(
