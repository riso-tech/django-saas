...
var t = require('@form-validation/core'),
  e = require('@form-validation/plugin-field-status'),
  o = function (t, e) {
    return (
      (o =
...
var i = (function (t) {
  function i(e) {
    ...
    return (
      ...
      (o.opts = Object.assign({}, { onPrefocus: function () {} }, e)),
  ...
  return (
    ...
    (i.prototype.install = function () {
      this.core
        ...
        .registerPlugin(this.fieldStatusPluginName, new e.FieldStatus());
    }),
    ...
    (i.prototype.onFormInvalid = function () {
      var t = this.core.getPlugin(this.fieldStatusPluginName).getStatuses(),
        e = Object.keys(this.core.getFields()).filter(function (e) {
          return 'Invalid' === t.get(e);
        });
      if (e.length > 0) {
        var o = e[0],
