      ...
      this.core.registerValidator(
        ...
        this.fields.forEach(function (e) {
          ...
          t.core.addField(e, {
            validators:
              ((r = {}),
              (r[n.INT_TEL_VALIDATOR] = { message: t.opts.message }),
              r),
          });
          var o = t.core.getElements(e)[0],
            i = function () {
              return t.core.revalidateField(e);
            };
          o.addEventListener('countrychange', i),
            t.countryChangeHandler.set(e, i),
            t.fieldElements.set(e, o),
            t.intlTelInstances.set(e, intlTelInput(o, t.opts));
        });
    }),
    (n.prototype.uninstall = function () {
      var t = this;
      this.fields.forEach(function (e) {
        var r = t.countryChangeHandler.get(e),
          o = t.fieldElements.get(e),
          i = t.getIntTelInstance(e);
        r &&
          o &&
          i &&
