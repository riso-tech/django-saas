...
from one.utils.contrib.admin import DjangoObjectActions, action, takes_instance_or_queryset

from .models import Category, Choice, Comment, Entry, Poll, RelatedData
...
class ChoiceAdmin(DjangoObjectActions, admin.ModelAdmin):
    ...
    def edit_poll(self, request, obj):
        url = reverse("admin:tests_poll_change", args=(obj.poll.pk,))
