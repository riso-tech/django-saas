...
(function ($) {
    ...
    init: function (options) {
      ...
      return this.each(function () {
        ...
        options = $.extend(
          ...
          $.fn.grp_autocomplete_m2m.defaults,
          options,
        );
        ...
        options.wrapper_autocomplete.on('click', function (e) {
          ...
          if (
            !$(e.target).hasClass('related-lookup') &&
            !$(e.target).hasClass('grp-related-remove')
          ) {
  ...
  $.fn.grp_autocomplete_m2m = function (method) {
    if (methods[method]) {
      ...
      $.error(
        'Method ' + method + ' does not exist on jQuery.grp_autocomplete_m2m',
      );
    }
    return false;
  };
  ...
  var repr_add = function (elem, label, options) {
    ...
    var removelink = $(
      '<a class="grp-m2m-remove" href="javascript://"></a>',
    ).text(label);
    ...
    options.wrapper_search
      ...
      .autocomplete({
        ...
        position: {
          my: 'left top',
          at: 'left bottom',
          of: options.wrapper_autocomplete,
        },
