...
(function ($) {
  var methods = {
    init: function (options) {
      ...
      return this.each(function () {
        ...
        if (
          $this.next().next() &&
          $this.next().next().attr('class') != 'errorlist' &&
          $this.next().next().attr('class') != 'grp-help'
        )
  ...
  $.fn.grp_autocomplete_fk = function (method) {
    if (methods[method]) {
      ...
      $.error(
        'Method ' + method + ' does not exist on jQuery.grp_autocomplete_fk',
      );
    }
    return false;
  };
