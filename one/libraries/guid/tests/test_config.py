...
UUID_LENGTH_IS_NOT_CORRECT_RANGE_HEX_FORMAT = "UUID_LENGTH must be between 1-32 when UUID_FORMAT is hex"
UUID_LENGTH_IS_NOT_CORRECT_RANGE_STRING_FORMAT = "UUID_LENGTH must be between 1-36 when UUID_FORMAT is string"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (33, "hex", UUID_LENGTH_IS_NOT_CORRECT_RANGE_HEX_FORMAT),
        (37, "string", UUID_LENGTH_IS_NOT_CORRECT_RANGE_STRING_FORMAT),
    ],
)
