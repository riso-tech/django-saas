...
function pathsConfig(appName) {
  ...
  return {
    vendorsJs: [
      ...
      `${this.app}/static/vendors/@form-validation/umd/bundle/popular.min.js`,
      `${this.app}/static/vendors/@form-validation/umd/bundle/full.min.js`,
      `${this.app}/static/vendors/@form-validation/umd/plugin-bootstrap5/index.min.js`,
      ...
      `${this.app}/static/vendors/toastr/build/toastr.min.js`,
    ...
    vendorsCss: [
      ...
      `${this.app}/static/vendors/@form-validation/umd/styles/index.css`,
      ...
      `${this.app}/static/vendors/toastr/build/toastr.css`,
